...
- **[中国计算机学会A类期刊]** Long Zheng, Ao Hu, **<ins>Qinggang Wang (Corresponding author)</ins>**, Yu Huang, Haoqin Huang, Pengcheng Yao, Shuyi Xiong, Xiaofei Liao, Hai Jin. PhGraph: A High-Performance ReRAM-Based Accelerator for Hypergraph Applications. In ***IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems***, 2024.
